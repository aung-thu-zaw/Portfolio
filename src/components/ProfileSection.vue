...
<template>
  ...
  >
    <div class="space-y-5 text-center md:text-left">
      <p class="font-semibold uppercase text-md text-lightText">Hi There 👋🏼 , I'm</p>

      <h1 class="text-6xl font-extrabold text-lightText">Aung Thu Zaw</h1>

      <p class="text-lg font-semibold text-lightText">Full Stack Web Developer</p>

      <p
        class="text-md text-slate-400 max-w-[500px] mx-auto md:mx-0 text-center md:text-left !mb-14"
      >
        I specialize in creating dynamic and responsive web applications using modern web
        technologies. With a passion for both front-end and back-end development, I enjoy turning
        ideas into fully functional digital experiences.
      </p>
    ...
    <div class="flex items-center justify-center w-full space-x-3 md:justify-start">
      ...
      <SocialLinkButton
        href="https://github.com/aung-thu-zaw?tab=repositories"
